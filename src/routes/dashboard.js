 ...
 * @access  Protected (Requires active Dealer/Agent Auth Bearer token)
 */
router.get('/listings', authGuard, getListings);
 ...
 * @access  Protected
 */
router.patch('/listings/:id/boundary', authGuard, updateListingBoundary);
 ...
 */
router.get('/analytics', authGuard, getDashboardAnalytics);
 ...
 */
router.post('/users/invite', authGuard, inviteTenantUser);
